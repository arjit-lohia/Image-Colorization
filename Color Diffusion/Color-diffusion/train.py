...
if __name__ == "__main__":
    ...
    parser.add_argument("--cpu-only", default=True)
    ...
    train_dl, val_dl = make_dataloaders(args.dataset, colordiff_config, num_workers=0, limit=100000)
    ...
    logger = CSVLogger(save_dir="logs", name="training_logs")
