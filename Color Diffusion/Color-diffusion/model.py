...
class ColorDiffusion(pl.LightningModule):
    ...
    #     if self.should_log:
    #         self.log("val_loss", losses["total loss"], on_epoch=True, prog_bar=True)
    ...
    def validation_step(self, batch, batch_idx):
        ...
        val_loss = losses["total loss"]

        # Log `val_loss` correctly
        self.log("val_loss", val_loss, on_epoch=True, on_step=False, prog_bar=True, sync_dist=True)
    ...
    def on_validation_epoch_end(self):
        ...
        # # Clear stored losses for next epoch
